...
import sty from "./PlasmicTestimonial.module.css"; // plasmic-import: nlqA5pbN9rjwz/css
...
function PlasmicTestimonial__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.column__rvJqf)}>
        <h2
        ...
        >
          <div className={classNames(projectcss.all, sty.column__srMem)}>
            <p.PlasmicImg
              ...
              src={{
                src: "/plasmic/saa_s_website/images/smalljpg.jpeg",
                fullWidth: 160,
                fullHeight: 160,
          ...
          <div className={classNames(projectcss.all, sty.column__weiIu)}>
            <h5
