...
import sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: 0gyvc7e6N-v0hr/css

import SUPER__PlasmicSelect from "./PlasmicSelect"; // plasmic-import: gX502w3JPF43f0/render
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option___1PK01)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option___9Auiu)}
              />
            </React.Fragment>
          ),
          value: args.children
