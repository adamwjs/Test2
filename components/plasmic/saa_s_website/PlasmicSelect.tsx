...
import Select__Overlay from "../../Select__Overlay"; // plasmic-import: EZao29aqsr7AVd/component
...
import sty from "./PlasmicSelect.module.css"; // plasmic-import: gX502w3JPF43f0/css

import ChevronDownsvgIcon from "./icons/PlasmicIcon__ChevronDownsvg"; // plasmic-import: aJGrlvSbtpHrDc/icon
import ChevronUpsvgIcon from "./icons/PlasmicIcon__ChevronUpsvg"; // plasmic-import: wbXjE_6J5bQQf4/icon
  ...
  if (!("children" in props)) {
    props = {
      ...
      children: (
        <React.Fragment>
          <Select__Option
            className={classNames("__wab_instance", sty.option__laDdL)}
            value={"value1" as const}
          >
            {"Option 1"}
          </Select__Option>
          ...
          <Select__Option
            className={classNames("__wab_instance", sty.option__tehbS)}
            value={"value2" as const}
          >
            {"Option 2"}
          </Select__Option>
