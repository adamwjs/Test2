...
import sty from "./PlasmicCtaBlock.module.css"; // plasmic-import: LW50Opyl_wWQb/css
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div className={classNames(projectcss.all, sty.column__fK9G)}>
            <h2
          ...
          <div className={classNames(projectcss.all, sty.column__xHwv8)}>
            <Button
